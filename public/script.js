...
socket.on("game_started",({drawerId:newDrawerId})=>{drawerId=newDrawerId;gameStarted=true;canDraw=socket.id===drawerId;clearCanvas();gameStatus.textContent=canDraw?"🎨 You are drawing!":"👀 Guess the drawing!";wordLabel.textContent=canDraw?"🤫 Your secret word will appear here.":"🔤 Guess the word!";canvas.style.cursor=canDraw?"crosshair":"default"});
